...
args_strIn = '/home/zivid/pytorch_env/LineDetection/images/results3.png'
args_strOut = './out.png'
##########################################################
...
def run_hed(args_strModel = 'bsds500', args_strIn = '/home/zivid/pytorch_env/LineDetection/images/results3.png', args_strOut = './out2.png'):
    ...
    image = PIL.Image.fromarray((tenOutput.clip(0.0, 1.0).numpy().transpose(1, 2, 0)[:, :, 0] * 255.0).astype(numpy.uint8)).save(args_strOut)
    return args_strOut
# end
