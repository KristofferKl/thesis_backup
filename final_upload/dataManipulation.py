...
def canny(image_name_in):
    ...
    # edges2 = ski.feature.canny(image, sigma=2, low_threshold=0.3*max_val, high_threshold=0.4*max_val)
    ...
    # ski.io.imsave("canny_sigma1-03.png", edges1)
...
######################### transform
    ...
    #     # weld_path_new= df_translation(vector=offset_vec,points=weld_path) #used for only translation
    #     weld_path_new= df_transform1(T12, weld_path)
    #     weld_path_new.to_csv("offest_" + path_name, header=None, index=None)
