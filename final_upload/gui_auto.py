...
#  this wil be used!!
# screw= np.array([726.673, 275.958, -601.059, 168.9588, -50.7845, -19.5006]) # test0306

# screw= np.array([797.77, 205.278, -680.923, 175.1725, -47.4262, -9.2829]) # test0406-1
screw= np.array([726.694, 275.921, -601.061, 168.9561, -50.7837, -19.4969])#test0406-2
# screw= np.array([620.831, 331.986, -613.144, -7.2096, -15.1919, -26.1971])#test0406-3 ????
...
def main():
    ...
    df= pd.read_csv('test0606-5-template.csv', sep = ',', header= None)
...
#####################################################THE DOUBLE IMPLEMENTATION should be streamlined, but works for now
    ...
    create_combined_layer_visualization()
...
#####################################################################################################################
    ...
    # total_edge_detection_time= skeleton_time_end-start_time
    # print(f"time up to: {total_edge_detection_time = }")
